...
class BaseModelArguments:
    ...
    local_qwen2_5_vl_path: Optional[str] = field(
        default=None,
        metadata={
            "help": (
                "Local path (absolute or relative) to custom `qwen2_5_vl` model code directory. "
                "When set, this directory will override `transformers.models.qwen2_5_vl` during loading."
            )
        },
    )
