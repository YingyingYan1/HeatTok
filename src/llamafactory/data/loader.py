...
def _get_preprocessed_dataset(
    ...
    if not data_args.streaming:
        num_proc = data_args.preprocessing_num_workers
        if getattr(data_args, "use_semantic_patches", False):
            num_proc = 1
...
def get_dataset(
    ...
    # English comment.
    if hasattr(data_args, "use_semantic_patches") and data_args.use_semantic_patches and processor is not None:
        try:
            from ..utils.sam_model_loader import load_sam_model
            import torch
